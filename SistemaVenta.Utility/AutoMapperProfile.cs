    ...
    public class AutoMapperProfile : Profile
    {
        public AutoMapperProfile() 
        {
            ...
            CreateMap<Usuario, UsuarioDTO>()
                ...
                .ForMember(destino =>
                    destino.EsActivo,
                    opt => opt.MapFrom(origen => origen.EsActivo == true ? 1 : 0)    //bool to int
                );
            ...
            CreateMap<UsuarioDTO, Usuario>()
                ...
                .ForMember(destino =>
                    destino.EsActivo,
                    opt => opt.MapFrom(origen => origen.EsActivo == 1 ? true : false)    //int to bool
                );
            #endregion
            ...
            CreateMap<Producto, ProductoDTO>()
                ...
                .ForMember(destino =>
                    destino.Precio,
                    opt => opt.MapFrom(origen => Convert.ToString(origen.Precio.Value, new CultureInfo("es-PE"))) //conversion de decimal a string
                )
                .ForMember(destino =>
                    destino.EsActivo,
                    opt => opt.MapFrom(origen => origen.EsActivo == true ? 1 : 0)       //conversion de bool a int
                );
            ...
            CreateMap<ProductoDTO, Producto>()
                ...
                .ForMember(destino =>
                    destino.Precio,
                    opt => opt.MapFrom(origen => Convert.ToDecimal(origen.Precio, new CultureInfo("es-PE"))) //conversion de int a string
                )
                .ForMember(destino =>
                    destino.EsActivo,
                    opt => opt.MapFrom(origen => origen.EsActivo == 1 ? true : false)       //conversion de bool a int
                );

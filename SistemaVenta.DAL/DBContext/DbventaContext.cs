...
public partial class DbventaContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240C7635EFBB");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843FC95F5CDE");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF4839691AE4B");
        ...
        {
            entity.HasKey(e => e.IdMenuRol).HasName("PK__MenuRol__9D6D61A47325F777");
        ...
        {
            entity.HasKey(e => e.IdNumeroDocumento).HasName("PK__NumeroDo__471E421A4CCE3CC7");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A132D80C7A30");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F762478F40F");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A666EC801F");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D5614E93BECC0");
